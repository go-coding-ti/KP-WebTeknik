<div class="container mt-5 pt-5">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
    <h1 class="h4 fw-bold text-light border-2 border-bottom border-danger p-2">Trending</h1>
      ...
      <div class="card bg-grey hover border-0 h-100">
        <a href="#" class="link-light text-decoration-none ">
          ...
          <div class="card-body p-3">
            <a href="#" class="btn btn-sm btn-primary p-1 text-uppercase my-1"><small>Teknologi</small></a>
            <a href="#" class="btn btn-sm btn-success p-1 text-uppercase my-1"><small>Knowledge</small></a>
            <p class="card-text h5 fw-bold mt-3"><a href="" class="text-decoration-none link-light link-hover">Judul dari Konten Berita yang sedang Tranding di Fakultas Teknik, Universitas Udayana atau Secara Umum Max 110</a></p>
          </div>
        </a>
