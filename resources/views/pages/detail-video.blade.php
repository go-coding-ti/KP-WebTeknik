  ...
  @if (App::getLocale() == 'en')
    <div class="container pt-5">
        <div class="card mb-3">
          ...
          <div class="row">
            <div class="col-12">
              <a href="{{ route('Video', app()->getLocale()) }}" class="btn btn-danger float-end">Return Back</a>
            </div>
          </div>
    </div>
  @endif
  ...
  @if (App::getLocale() == 'id')
    <div class="container pt-5">
        <div class="card mb-3">
          ...
          <div class="row">
            <div class="col-12">
              <a href="{{ route('Video', app()->getLocale()) }}" class="btn btn-danger float-end">Kembali</a>
            </div>
          </div>
    </div>
  @endif
