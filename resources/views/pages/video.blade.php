        ...
        <div class="col-12 col-md-5 col-lg-4 p-0 px-1">
          <ul class="nav vizew-nav-tab" role="tablist">
            <li class="nav-item hover">
              <a class="nav-link active" href="{{ route("Detail Video", app()->getLocale() ) }}">
  ...
  <div class="container pt-5">
    {{-- <div class="row">
      <div class="col-md-12 col-lg-8 mb-3">
        <div class="card border-0 bg-grey h-100">
          <div class="ratio ratio-21x9 card-img-top">
            <iframe src="https://www.youtube.com/embed/ybOI_hQnNz8?controls=0" title="Judul Videonya" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope;" allowfullscreen></iframe>
          </div>
          <div class="card-body text-center">
            <h5 class="card-title text-light fw-bold">Mars Teknik Udayana</h5>
            <p class="card-text text-light lh-sm">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
            <a href="" class="card-text text-black small text-decoration-none link-danger"><i class="fab fa-youtube"></i> See on YouTube</a>
          </div>
          <div class="card-footer text-center">
      ...
      <div class="col-md-12 col-lg-4 overflow-auto rounded scrollbar">
        <div class="row row-cols-2 row-cols-lg-1 g-4">
          <div class="col">
            <div class="card border-0 bg-grey h-100">
              <div class="ratio ratio-21x9 card-img-top">
                <iframe src="https://www.youtube.com/embed/ybOI_hQnNz8?controls=0" title="Judul Videonya"></iframe>
              </div>
              <div class="card-body text-center">
