        ...
        <div class="card shadow mb-4">
            ...
            <form id="form-product" method="post" action="{{route('admin-download-store')}}" enctype="multipart/form-data">
                ...
                <div class="form group mt-5">
                    ...
                    <input type="text" class="form-control" id="title_ina" name="title_ina" placeholder="Nama Dokumen Indonesia" required>
                </div>
                <div class="form group mt-4">
                    <label for="title">Nama Dokumen Eng</label>
                    <input type="text" class="form-control" id="title_eng" name="title_eng" placeholder="Nama Dokumen Inggris" required>
                </div>
                <div class="form group mt-4">
                    <label for="urlvideo">URL File</label>
                    <input type="text" class="form-control" id="urlfile" name="urlfile" placeholder="URL Dokumen" required>
                </div>
                <div class="form-group mt-5">
