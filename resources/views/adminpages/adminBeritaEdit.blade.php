...
<div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form action="{{route('admin-berita-update')}}" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea type="text" class="form-control" name="judul" id="judul" rows="1">{{$berita->judul}}</textarea>
                                    <!-- @if($errors->has('judul'))
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="konten" id="konten" rows="10">{{$berita->isi_berita}}</textarea>
                    ...
                    <button type="submit" class="btn btn-success"><i class="fa fa-save"></i>Update Berita</button>
                </form>
            </div>
          </div>
@endsection
