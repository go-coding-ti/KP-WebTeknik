...
<div class="container-fluid">
    ...
    <p class="mb-4">Edit Menu Fakultas Teknik Universitas Udayana</p>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
        <form id="form-product" method="post" action="{{route('admin-menu-update', $menu->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <label for="title">Menu Bahasa Indonesia</label>
                    <input type="text" class="form-control @error ('menu_ina') is-invalid @enderror"  id="menu_ina" name="menu_ina" placeholder="Menu Bahasa Indonesia" value="{{$menu->menu_ina}}" required>
                    @error('menu_ina')
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="text" class="form-control @error ('menu_eng') is-invalid @enderror" id="menu_eng" name="menu_eng" placeholder="Menu Bahasa Inggris" value="{{$menu->menu_eng}}" required>
                    @error('menu_eng')
                        <div class="invalid-feedback text-start">
                            {{ $message }}
                        </div>
                    @else
                        <div class="invalid-feedback">
                            Menu Bahasa Inggris wajib diisi
                        </div>
                    @enderror
                </div>
            </div>
