...
@section('content')
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <form id="form-product" method="post" action="{{route('admin-submenu-store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <label for="title">Sub Menu Ina</label>
                        <input type="text" class="form-control @error ('title_ina') is-invalid @enderror"  id="menu_ina" name="menu_ina" placeholder="Judul Bahasa Indonesia" required>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <label for="title">Sub Menu Eng</label>
                        <input type="text" class="form-control" id="menu_eng" name="menu_eng" placeholder="Judul Bahasa Inggris" required>
                    </div>
                </div>
