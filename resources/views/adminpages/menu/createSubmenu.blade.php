...
<div class="container-fluid">
    ...
    <p class="mb-4">Tambah Sub Menu Fakultas Teknik Universitas Udayana</p>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
        <form id="form-product" method="post" action="{{route('admin-submenu-store')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <label for="title">Sub Menu Bahasa Indonesia</label>
                    <input type="text" class="form-control @error ('menu_ina') is-invalid @enderror"  id="menu_ina" name="menu_ina" placeholder="Sub menu Bahasa Indonesia" required>
                    @error('menu_ina')
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="text" class="form-control @error ('menu_eng') is-invalid @enderror" id="menu_eng" name="menu_eng" placeholder="Sub menu Bahasa Inggris" required>
                    @error('menu_eng')
                        <div class="invalid-feedback text-start">
                            {{ $message }}
                        </div>
            ...
            <div class="form-group form-group mt-4" id="menu_div" style="display:none;">
