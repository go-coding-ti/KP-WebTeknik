...
<div class="container-fluid">
    ...
    <p class="mb-4">Edit Galeri Fakultas Teknik Universitas Udayana</p>
    ...
    <div class="card shadow mb-4">
        ...
        <form id="form-product" method="post" action="{{route('admin-galeri-update', $galeri->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="form group mt-1">
                ...
                <input type="text" class="form-control @error ('title_ina') is-invalid @enderror" id="title_ina" name="title_ina" placeholder="Judul Bahasa Indonesia" value="{{$galeri->title_ina}}" required>
                @error('title_ina')
            ...
            <div class="form group mt-4">
                ...
                <input type="text" class="form-control @error ('title_eng') is-invalid @enderror" id="title_eng" name="title_eng" placeholder="Judul Bahasa Inggris" value="{{$galeri->title_eng}}" required>
                @error('title_eng')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group form-group mt-4">
                ...
                <textarea id="deskripsi_ina" class="form-control @error ('deskripsi_ina') is-invalid @enderror" name="deskripsi_ina" placeholder="Deskripsi Galeri Bahasa Indonesia" rows="10" required>{{$galeri->deskripsi_ina}}</textarea>
                @error('deskripsi_ina')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group form-group mt-4">
                ...
                <textarea id="deskripsi_eng" class="form-control @error ('deskripsi_eng') is-invalid @enderror" name="deskripsi_eng" placeholder="Deskripsi Galeri Bahasa Inggris" rows="10" required>{{$galeri->deskripsi_eng}}</textarea>
                @error('deskripsi_eng')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group mt-4">
                ...
                @if($galeri->galeri != "")
                    ...
                    <img src="{{$galeri->galeri}}" style="border: 2px solid #DCDCDC;padding: 5px;height:20%;width:20%;" id="propic">
...
<div class="modal fade" id="crop-image" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title">Ganti Galeri</h5>
        ...
        <div class="modal-body">
            <div class="row" style="margin: 20px">
                <img  src="{{$galeri->galeri}}" id="image-preview"  width="100%" height="100%" alt="">
