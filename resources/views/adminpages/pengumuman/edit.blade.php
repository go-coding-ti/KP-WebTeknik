...
@section('content')
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <form id="form-product" method="post" action="{{route('admin-pengumuman-update', $pengumuman->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <input type="date" class="form-control" name="tanggal" placeholder="Tanggal Publish" value="{{$pengumuman->tanggal_publish}}" required>
                    </div>
                </div>
                ...
                <div class="form group mt-5">
                    ...
                    <input type="text" class="form-control" id="title_eng" name="title_eng" placeholder="Judul Bahasa Inggris" value="{{$pengumuman->title_eng}}" required>
                </div>
                <div class="form-group form-group mt-4">
