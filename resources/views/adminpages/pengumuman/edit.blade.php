...
<div class="container-fluid">
    ...
    <p class="mb-4">Edit Pengumuman Fakultas Teknik Universitas Udayana</p>
        ...
        <form id="form-product" method="post" action="{{route('admin-pengumuman-update', $pengumuman->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="text" class="form-control @error ('title_ina') is-invalid @enderror"  id="title_ina" name="title_ina" placeholder="Judul Bahasa Indonesia" value="{{$pengumuman->title_ina}}" required>
                    @error('title_ina')
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="date" class="form-control @error ('tanggal') is-invalid @enderror" name="tanggal" placeholder="Tanggal Publish" value="{{$pengumuman->tanggal_publish}}" required>
                    @error('tanggal')
                        <div class="invalid-feedback text-start">
                            {{ $message }}
                        </div>
            ...
            <div class="form-group form-group mt-4">
                ...
                <select class="form-control @error ('kategori') is-invalid @enderror" data-live-search="true" id="kategori" rows="3" name="kategori" required>
                    ...
                    @foreach ($kategori as $kategori)
                        <option value="{{$kategori->id}}" @if($pengumuman->id_kategori==$kategori->id) selected @endif>{{$kategori->kategori_ina}}</option>
                    @endforeach
                </select>
                @error('kategori')
                    <div class="invalid-feedback text-start">
                ...
                @else
                    <div class="invalid-feedback">
                        Kategori pengumuman wajib diisi
                    </div>
                @enderror  
            </div>
            <div class="form-group form-group mt-4">
            ...
            <div class="form group mt-5">
                ...
                <input type="text" class="form-control @error ('title_eng') is-invalid @enderror" id="title_eng" name="title_eng" placeholder="Judul Bahasa Inggris" value="{{$pengumuman->title_eng}}" required>
                @error('title_eng')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
