...
<div class="container-fluid">
    ...
    <p class="mb-4">Edit Berita Fakultas Teknik Universitas Udayana</p>
        ...
        <form id="form-product" method="post" action="/admin/news/{{$berita->id}}" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="text" class="form-control @error ('title_ina') is-invalid @enderror"  id="title_ina" name="title_ina" value="{{$berita->title_ina}}" placeholder="Masukkan judul Bahasa Indonesia" required>
                    @error('title_ina')
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="date" class="form-control @error ('tanggal') is-invalid @enderror" id="tanggal" name="tanggal" value="{{$berita->tanggal_publish}}" required>
                    @error('tanggal')
                        <div class="invalid-feedback text-start">
                            {{ $message }}
                        </div>
            ...
            <div class="form group mt-5">
                ...
                <input type="text" class="form-control @error ('title_eng') is-invalid @enderror" id="title_eng" name="title_eng" value="{{$berita->title_eng}}" placeholder="Masukkan judul Bahasa Inggris" required>
                @error('title_eng')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
